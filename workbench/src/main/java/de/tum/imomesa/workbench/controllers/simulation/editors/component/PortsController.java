...
public class PortsController extends AbstractElementController<OverviewElement<Port>> {
	...
	@Override
	public void render() {
		component = (DefinitionComponent) extendedContext.get(extendedContext.size() - 1);

		List<DefinitionPort> ports = component.getPorts();

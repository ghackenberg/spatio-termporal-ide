package de.tum.imomesa.workbench.controllers.simulation.editors.port;
...
public class PortsController extends AbstractElementController<OverviewElement<DefinitionPort>> {
	...
	private InteractionMaterialPort parent;
	private Map<DefinitionPort, XYChart<?, ?>> charts = new HashMap<>();

	@Override
	public void render() {
		parent = (InteractionMaterialPort) extendedContext.get(extendedContext.size() - 1);

		List<DefinitionPort> ports = parent.getPorts();

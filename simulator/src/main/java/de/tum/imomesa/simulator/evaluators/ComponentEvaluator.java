...
public abstract class ComponentEvaluator<T extends Component<?>> extends AbstractEvaluator<T> {

	public ComponentEvaluator(List<Element> context, T element, Memory memory, int step) {

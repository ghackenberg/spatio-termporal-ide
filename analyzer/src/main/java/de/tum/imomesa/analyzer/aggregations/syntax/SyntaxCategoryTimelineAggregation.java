...
public class SyntaxCategoryTimelineAggregation extends TimelineAggregation<String> {

	public SyntaxCategoryTimelineAggregation(List<Change> changes, List<Event> events, Discretizer discretizer) {

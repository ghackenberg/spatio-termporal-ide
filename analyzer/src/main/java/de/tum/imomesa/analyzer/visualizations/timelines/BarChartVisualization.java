...
public class BarChartVisualization<T> extends Visualization<Map<T, List<Integer>>, BarChart<String, Number>> {

	private List<T> order;
	private Discretizer discretizer;

	public BarChartVisualization(Map<T, List<Integer>> data, List<T> order, Discretizer discretizer) {
		super(data);
	...
	@Override
	protected BarChart<String, Number> generateResult() {
		// Convert to chart
